...
_[Published on https://codurance.com/2019/05/18/microservices-adventures/[codurance] https://medium.com/@AndrzejRehmann/microservices-adventures-ignoring-platform-complexity-b1820d8fb53d[medium]]_
